...
-- Diagnostic keymaps
vim.keymap.set("n", "ek", vim.diagnostic.goto_prev, { desc = "Go to previous [D]iagnostic message" })
vim.keymap.set("n", "ej", vim.diagnostic.goto_next, { desc = "Go to next [D]iagnostic message" })
